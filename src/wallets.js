...
async function initSolana() {
  ...
  // Solana-Secretkeys sind exakt 64 Byte. 32 Byte = vermutlich eine Adresse -> ablehnen!
  if (secret.length !== 64) {
    console.error(`SOLANA_PRIVATE_KEY hat ${secret.length} Byte, erwartet 64. ` +
  ...
  let keypair;
  try { keypair = Keypair.fromSecretKey(secret); }
