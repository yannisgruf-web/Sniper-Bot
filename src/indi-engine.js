...
function openPos(sym, price, v, side) {
  ...
  // Kleiner Sicherheitspuffer (90%), da vorher Gebühren/Funding anfallen.
...
function start() {
  ...
  console.log(`[INDI] Engine aktiv (Quelle ${QUELLE}): Top-${cfg.INDI_TOP_N} Symbole, 15m, ${cfg.INDI_MIN_VOTES}er-Konfluenz, Shorts=${cfg.INDI_SHORTS ? "AN" : "aus"}, Hebel ${cfg.INDI_LEVERAGE}x, virtuell ${cfg.INDI_START_USD}$`);
}
